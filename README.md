...
1- Product Management: Roadmap, MVP definition, discovery, prioritization, stakeholder alignment
2- Technical Product Management: Claude Code (power user), Agent SDK, MCP servers, agentic systems, prompt engineering, AI/LLM evals
3- Project Management: Sprint management, QA, releases, remote team coordination, delivery
4- Team Leadership: Remote team management, hiring, embedded consulting
5- Backend: Node.js, NestJS, Python, REST APIs, GraphQL
6- Frontend: React, Next.js, TypeScript, JavaScript
7- AI & Automation: CustomGPT, LangChain, OpenAI, YOLOv8, AI video processing
8- DevOps & Infrastructure: Docker, AWS, DigitalOcean, Linode, CI/CD, proxy networks
